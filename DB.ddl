...
CREATE USER C##ADMIN_ECOMSTORE IDENTIFIED BY "Robin2007"
DEFAULT TABLESPACE users
QUOTA UNLIMITED ON users;

-- 2. USUARIO DESARROLLADOR
CREATE USER C##DEV_ECOMSTORE IDENTIFIED BY "Wilian2007"
DEFAULT TABLESPACE users
QUOTA UNLIMITED ON users;

-- 3. USUARIO GERENTE
CREATE USER C##GERENTE_ECOMSTORE IDENTIFIED BY "Sosa2805"
DEFAULT TABLESPACE users
QUOTA UNLIMITED ON users;

-- 4. USUARIO VENDEDOR
CREATE USER C##VENDEDOR_ECOMSTORE IDENTIFIED BY "Covenas2007"
DEFAULT TABLESPACE users
QUOTA UNLIMITED ON users;

-- 5. USUARIO ALMACÉN
CREATE USER C##ALMACEN_ECOMSTORE IDENTIFIED BY "28Mayo2007"
DEFAULT TABLESPACE users
QUOTA UNLIMITED ON users;

-- 6. USUARIO CONTABILIDAD
CREATE USER C##CONTA_ECOMSTORE IDENTIFIED BY "RobinWilian"
DEFAULT TABLESPACE users
QUOTA UNLIMITED ON users;

-- 7. USUARIO MARKETING
CREATE USER C##MARKETING_ECOMSTORE IDENTIFIED BY "SosaCoveñas"
DEFAULT TABLESPACE users
QUOTA UNLIMITED ON users;

-- 8. USUARIO CONSULTOR/REPORTES
CREATE USER C##REPORTES_ECOMSTORE IDENTIFIED BY "2007Mayo28"
DEFAULT TABLESPACE users
QUOTA UNLIMITED ON users;

-- OTORGAR PERMISOS BÁSICOS DE CONEXIÓN
GRANT CREATE SESSION TO C##ADMIN_ECOMSTORE;
GRANT CREATE SESSION TO C##DEV_ECOMSTORE;
GRANT CREATE SESSION TO C##GERENTE_ECOMSTORE;
GRANT CREATE SESSION TO C##VENDEDOR_ECOMSTORE;
GRANT CREATE SESSION TO C##ALMACEN_ECOMSTORE;
GRANT CREATE SESSION TO C##CONTA_ECOMSTORE;
GRANT CREATE SESSION TO C##MARKETING_ECOMSTORE;
GRANT CREATE SESSION TO C##REPORTES_ECOMSTORE;

-- CREAR ROLES 
CREATE ROLE C##ROL_ADMIN_TOTAL;
CREATE ROLE C##ROL_DESARROLLADOR;
CREATE ROLE C##ROL_GERENCIA;
CREATE ROLE C##ROL_VENTAS;
CREATE ROLE C##ROL_ALMACEN;
CREATE ROLE C##ROL_CONTABILIDAD;
CREATE ROLE C##ROL_MARKETING;
CREATE ROLE C##ROL_CONSULTAS;

-- ASIGNAR PERMISOS
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_CLIENTE TO C##ROL_ADMIN_TOTAL;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_PRODUCTO TO C##ROL_ADMIN_TOTAL;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_CATEGORIA TO C##ROL_ADMIN_TOTAL;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_PEDIDO TO C##ROL_ADMIN_TOTAL;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_DETAL_PEDI TO C##ROL_ADMIN_TOTAL;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_INVENTARIO TO C##ROL_ADMIN_TOTAL;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_METODO_PAGO TO C##ROL_ADMIN_TOTAL;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_FACTURA TO C##ROL_ADMIN_TOTAL;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_ENVIO TO C##ROL_ADMIN_TOTAL;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_RESENA TO C##ROL_ADMIN_TOTAL;

-- PERMISOS PARA DESARROLLADOR
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_CLIENTE TO C##ROL_DESARROLLADOR;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_PRODUCTO TO C##ROL_DESARROLLADOR;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_PEDIDO TO C##ROL_DESARROLLADOR;
GRANT SELECT, INSERT, UPDATE, DELETE ON ECOM_DETAL_PEDI TO C##ROL_DESARROLLADOR;

-- PERMISOS PARA GERENCIA (SOLO LECTURA DE TODO)
GRANT SELECT ON ECOM_CLIENTE TO C##ROL_GERENCIA;
GRANT SELECT ON ECOM_PRODUCTO TO C##ROL_GERENCIA;
GRANT SELECT ON ECOM_PEDIDO TO C##ROL_GERENCIA;
GRANT SELECT ON ECOM_DETAL_PEDI TO C##ROL_GERENCIA;
GRANT SELECT ON ECOM_INVENTARIO TO C##ROL_GERENCIA;
GRANT SELECT ON ECOM_FACTURA TO C##ROL_GERENCIA;

-- PERMISOS PARA VENTAS
GRANT SELECT ON ECOM_CLIENTE TO C##ROL_VENTAS;
GRANT SELECT ON ECOM_PRODUCTO TO C##ROL_VENTAS;
GRANT SELECT, INSERT ON ECOM_PEDIDO TO C##ROL_VENTAS;
GRANT SELECT, INSERT ON ECOM_DETAL_PEDI TO C##ROL_VENTAS;

-- PERMISOS PARA ALMACÉN
GRANT SELECT ON ECOM_PRODUCTO TO C##ROL_ALMACEN;
GRANT SELECT, UPDATE ON ECOM_INVENTARIO TO C##ROL_ALMACEN;

-- PERMISOS PARA CONTABILIDAD
GRANT SELECT ON ECOM_PEDIDO TO C##ROL_CONTABILIDAD;
GRANT SELECT ON ECOM_DETAL_PEDI TO C##ROL_CONTABILIDAD;
GRANT SELECT, INSERT ON ECOM_FACTURA TO C##ROL_CONTABILIDAD;

-- PERMISOS PARA MARKETING
GRANT SELECT ON ECOM_PRODUCTO TO C##ROL_MARKETING;
GRANT SELECT ON ECOM_RESENA TO C##ROL_MARKETING;
GRANT INSERT ON ECOM_RESENA TO C##ROL_MARKETING;

-- PERMISOS PARA CONSULTAS (SOLO LECTURA)
GRANT SELECT ON ECOM_CLIENTE TO C##ROL_CONSULTAS;
GRANT SELECT ON ECOM_PRODUCTO TO C##ROL_CONSULTAS;
GRANT SELECT ON ECOM_PEDIDO TO C##ROL_CONSULTAS;
GRANT SELECT ON ECOM_DETAL_PEDI TO C##ROL_CONSULTAS;

-- ASIGNAR ROLES A USUARIOS
GRANT C##ROL_ADMIN_TOTAL TO C##ADMIN_ECOMSTORE;
GRANT C##ROL_DESARROLLADOR TO C##DEV_ECOMSTORE;
GRANT C##ROL_GERENCIA TO C##GERENTE_ECOMSTORE;
GRANT C##ROL_VENTAS TO C##VENDEDOR_ECOMSTORE;
GRANT C##ROL_ALMACEN TO C##ALMACEN_ECOMSTORE;
GRANT C##ROL_CONTABILIDAD TO C##CONTA_ECOMSTORE;
GRANT C##ROL_MARKETING TO C##MARKETING_ECOMSTORE;
GRANT C##ROL_CONSULTAS TO C##REPORTES_ECOMSTORE;
